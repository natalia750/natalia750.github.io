$(function () {
  ...
  function setup() {
    ...
    createPlatform(500, 198, 200, 20);
    createPlatform(700, 300, 200, 20);
    createPlatform(699, 480, 200, 20);
    createPlatform(400, 400, 200, 20);
    createPlatform(750, 700, 200, 20);
    // TODO 2
    // Create collectables
    ...
    createCollectable("steve", 700, 400, 20, 0.5); // creates a "steve" collectible at the coordinates (500, 300), falling with a high gravity of 20, and bouncing with 50% bounce
